...
public interface ReviewRepository extends JpaRepository<Review, String> {
	...
	@Query(value = "SELECT * FROM bnk_review WHERE rvdate >= :from AND rvdate <= :to ORDER BY rvdate ASC", nativeQuery = true)
	List<Review> findByDateRange(@Param("from") String from, @Param("to") String to);
}
